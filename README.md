...
**Сейчас идёт этап планирования (итерация 2).** Код автоматизации ещё не пишем.
...
- [Вопросы, итерация 1](docs/voprosy-iteraciya-1.md) (частично закрыта)
- [Вопросы, итерация 2](docs/voprosy-iteraciya-2.md) — **ответьте на эти**, чтобы двигаться дальше
